...
function App() {
  return (
    <div className="overflow-y-scroll">
      <div className="bg-indigo-400 flex flex-col justify-center items-center h-screen ">
        <div className="flex flex-col lg:flex-row items-center ">
          <img
            className="w-40 h-36 rounded-full mb-10 lg:mb-0"
            src="https://media.discordapp.net/attachments/1005128452661321848/1117782328190701618/IMG_20230602_170631.jpg?width=316&height=421"
          />
          <div className=" text-black-800 text-xl lg:text-6xl font-mono ml-0 lg:ml-4 text-center">
            Hello I'm Manisha Dauthal!
            <div className="text-lg lg:text-3xl flex gap-2 mt-4">
              LET'S CONNECT:
              <a href="https://instagram.com/dauthalmishika?igshid=ZDdkNTZiNTM=">
                <img
              ...
              <a href="https://www.linkedin.com/in/manisha-dauthal-9116331aa">
                {" "}
                <img
                  className="w-6 lg:w-8"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-SjZuN0n2VqHGnb1UZI9d_RNPvT-oVHJoNNYIzLuOJA&s"
                />
              </a>
            </div>
          </div>
      ...
      <div className="bg-black flex flex-col items-center justify-center h-screen px-4">
        ...
        <h1 className="font-normal  text-black text-2xl lg:text-4xl mt-2 text-center">
          I am Manisha,<span className="px-2">Front-End Web Developer </span>
        </h1>
        <p className="lg:text-2xl text-lg text-center  text-gray-500 font-thin mt-2 px-10 ">
          Hi, I'm Manisha Dauthal,and I graduated from the Kumaun University in
          2022 with a degree in Bachelor of Science. My interests are in Front
      ...
      <div className="bg-indigo-400 h-screen overflow-y-scroll">
        <div className=" text-blue-800 lg:text-6xl text-xl flex justify-center items-start font-semibold">
